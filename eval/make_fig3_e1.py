"""
TraceGuard-DeFi — Figure 3: E1 PR curves (eval/make_fig3_e1.py)
================================================================
Precision-recall curves trên CÙNG test split (seed 42) cho:
  * Screener (4-view logistic fusion — fit trên train)
...
Nguồn số: cache (views recompute offline) + e1_train train_test_split +
...
from .e1_baselines import BASELINE_SCORERS, BASELINES  # noqa: E402
from .e1_train import SEED, build_dataset, train, train_test_split  # noqa: E402
from src.core.fusion import LogisticFusion  # noqa: E402
